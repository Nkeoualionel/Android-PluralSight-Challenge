        ...
        api.insertData(firstName, lastName, email, github).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    switch (response.code()){
                        case 200:
                            Toast.makeText(SubmitActivity.this, "AJOUT EFFECTUEE", Toast.LENGTH_LONG).show();
                            break;
                        case 404:
                        ...
                        case 500:
                            Toast.makeText(SubmitActivity.this, "ERREUR SERVEUR", Toast.LENGTH_LONG).show();
                            break;

                        default:
                            Toast.makeText(SubmitActivity.this, "ECHEC AJOUT", Toast.LENGTH_LONG).show();
                            break;
                    }
            }
